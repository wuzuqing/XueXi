...
public class OkHttpClientManager {
    ...
    public static void getAsync(String url, Map<String, String> params, final ResultCallback callback) {
        try {
            if (!NetWorkUtils.isNetConnected(BaseApplication.getAppContext())) {
                getInstance().sendFailedStringCallback(null, new NetworkErrorException(getInstance().getString(R
    ...
    public static void postAsync(String url, Map<String, String> params, final ResultCallback callback) {
        if (!NetWorkUtils.isNetConnected(BaseApplication.getAppContext())) {
            getInstance().sendFailedStringCallback(null, new NetworkErrorException(getInstance().getString(R.string
                    .network_error)), callback);
            return;
        }
        if (callback != null) callback.onStart();
